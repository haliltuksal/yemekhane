...
const navigationLinks = [
  ...
  { href: "/soguk-zincir", label: "Soğuk Zincir Ürünleri", icon: Snowflake },
  { href: "/paket-servis", label: "Paket Servis", icon: Package },
  { href: "/isyeri-cozumleri", label: "İşyeri Çözümleri", icon: Building2 },
      ...
      <div className="flex h-16 items-center justify-between gap-4">
              ...
              return (
                <NavigationMenuItem key={index}>
                  <NavigationMenuLink asChild>
                    <Link
                      href={link.href}
                      className="flex flex-row items-center gap-2 px-3 py-2 font-medium group/item hover:text-primary text-muted-foreground rounded-md hover:bg-accent transition-colors"
                    >
                      <Icon
                        size={16}
                        className="text-muted-foreground/80 group-hover/item:text-primary"
        ...
        <div className="flex items-center gap-2">
          ...
          <Button asChild size="sm" className="bg-primary hover:bg-primary/90 text-primary-foreground">
            <Link href="/siparis-ver" className="flex items-center gap-2">
